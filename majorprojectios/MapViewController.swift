...
class MapViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate, UISearchBarDelegate {
	...
	func searchVenues() {
		...
		alamoManager.request(.POST, API.searchVenuesURL ,parameters: venueParameters as! [String : AnyObject], encoding: .JSON).validate().responseJSON { [weak self] serverResponse in
	...
	func saveVenue(savedVenue: Dictionary<String, AnyObject>) {
		...
		/// Alamofire request made with validated params returend with the response.
		alamoManager.request(.POST,API.addNewVenueURL,parameters: savedVenue, encoding: .JSON).validate().responseJSON { [weak self] serverResponse in
